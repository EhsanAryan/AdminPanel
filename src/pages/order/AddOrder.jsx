                ...
                <div className="row my-1 justify-content-center">
                    <div className="col-12 col-md-4 col-lg-2 my-1">
                        <input type="text" className="form-control"
                            list="cart_list_select" placeholder="انتخاب سبد" />
                    ...
                    <div className="col-12 col-md-4 col-lg-2 my-1">
                        <input type="text" className="form-control"
                            value="پرداخت : 500,000 تومان" disabled />
                    </div>
                    <div className="col-12 col-md-4 col-lg-2 my-1">
                        <input type="text" className="form-control"
                            value="تخفیف : 5,000 تومان" disabled />
                    </div>
                    <div className="col-12 col-md-4 col-lg-2 my-1">
                    ...
                    <div className="col-12 col-md-6 col-lg-8">
                        <div className="input-group my-1 dir_ltr">
                            ...
                            <span className="input-group-text text-end w_70 font_08 d-flex align-items-center text_truncate">
                                ...
                                ( 100هزار تومان)
                                ( گارانتی فلان)
                                <i className="fas fa-circle mx-1 black-text"></i>
                            </span>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-8">
                        <div className="input-group my-1 dir_ltr">
                            ...
                            <span className="input-group-text text-end w_70 font_08 d-flex align-items-center text_truncate">
                                ...
                                ( 100هزار تومان)
                                ( گارانتی فلان)
                                <i className="fas fa-circle mx-1 red-text"></i>
                            </span>
                        </div>
                    </div>
                </div>
